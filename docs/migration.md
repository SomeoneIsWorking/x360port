...
1. Create `shared/xenonport` around Xenia `Memory`, `Processor`, `ThreadState`,
...
3. Move canonical typed imports into xenonport. Preserve function/variable
...
not prove xenonport or Xenia integration. Equivalent evidence must exercise the
shipping xenonport path. Gears' first consumer proof is real leaf `0x8222E868`,
